...
fetchUserProfile(0).then((user) => { console.log(user); }).catch((error) => { console.log(error) });
fetchUserPost(2).then((user) => { console.log(user); }).catch((error) => { console.log(error); });
fetchPostComments(100).then((user) => { console.log(user); }).catch((error) => { console.log(error); });